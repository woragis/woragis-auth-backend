...
func (e *AppError) ToHTTPStatus() int {
	...
	case e.Code == AUTH_INVALID_CREDENTIALS,
		e.Code == AUTH_PASSWORD_MISMATCH:
		return 401
	...
	// Not found - 404
	case e.Code == AUTH_USER_NOT_FOUND,
		e.Code == DB_RECORD_NOT_FOUND:
		return 404

	// Conflict - 409
	case e.Code == AUTH_EMAIL_ALREADY_EXISTS,
		e.Code == DB_DUPLICATE_ENTRY:
		return 409

	// Validation errors - 400
	case e.Code == AUTH_WEAK_PASSWORD,
		e.Code == VALIDATION_INVALID_EMAIL,
		e.Code == VALIDATION_INVALID_INPUT,
